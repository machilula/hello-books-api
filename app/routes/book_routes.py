...
from ..db import db
from .route_utilities import validate_model as validate_book
...
# hmm for these last twou routes, leaving Book out as the first argument of validate_book doesnt fail...
